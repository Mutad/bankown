...
return [
    ...
    */
    'bots'                         => [
        'tgbank' => [
            'username'            => 'tgbanking_bot',
            'token'               => env('TELEGRAM_BOT_TOKEN', '1319910324:AAHMm24_33hEoK8BhCQsucRex5hVU4IaigY'),
            'certificate_path'    => env('TELEGRAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url'         => env('TELEGRAM_WEBHOOK_URL', 'https://274d1a7227e7.ngrok.io/lol/webhook'),
            'commands'            => [
                //Acme\Project\Commands\MyTelegramBot\BotCommand::class
                App\Commands\Login::class,
                App\Commands\Menu::class,
                App\Commands\Start::class,
                App\Commands\Balance::class,
                App\Commands\Card::class,
                App\Commands\CardName::class,
                App\Commands\Cards::class,
                App\Commands\CardSettings::class,
                App\Commands\MakeDefaultCard::class,
                App\Commands\MakeTransaction::class,
