...
<div class="container legal">
    <div class="text-center">
        <h1>Bankown Terms and Conditions</h1>
    ...
    <ul>
        ...
        <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                or &quot;Our&quot; in this Agreement) refers to Bankown, Khmelnitsky Ukraine, 29000.</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Website</strong> refers to Bankown, accessible from <a href="https://www.mutado.ml"
                    rel="external nofollow noopener" target="_blank">https://www.mutado.ml</a></p>
        </li>
        <li>
